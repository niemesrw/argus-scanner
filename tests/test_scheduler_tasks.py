...
def scheduler_service(mock_settings):
    ...
    with patch('src.scheduler.tasks.BackgroundScheduler') as mock_scheduler_class, \
         patch('src.scheduler.tasks.NetworkDiscovery') as mock_discovery_class, \
         patch('src.scheduler.tasks.VulnerabilityScanner') as mock_vuln_scanner_class, \
         patch('src.scheduler.tasks.AlertManager') as mock_alert_manager_class, \
         patch('src.scheduler.tasks.get_db_session') as mock_get_db:
...
class TestSchedulerServiceInitialization:
    ...
    def test_start_scheduler(self, scheduler_service, mock_settings):
        ...
        assert db_update_call[1]['func'] == scheduler_service.update_vulnerability_database
...
class TestNetworkDiscovery:
    ...
    def test_run_network_discovery_success(self, scheduler_service, sample_scan):
        ...
        with patch('src.scheduler.tasks.Scan') as mock_scan_class, \
             patch.object(scheduler_service, '_check_new_devices') as mock_check_new, \
    ...
    def test_run_network_discovery_with_deep_scan(self, scheduler_service, sample_scan, sample_device):
        ...
        with patch('src.scheduler.tasks.Scan') as mock_scan_class, \
             patch.object(scheduler_service, '_check_new_devices'), \
             patch.object(scheduler_service, '_should_deep_scan') as mock_should_deep:
            ...
            scheduler_service.discovery.deep_scan_device.assert_called_once_with('192.168.1.100')
    
    def test_run_network_discovery_error(self, scheduler_service, sample_scan):
        """Test network discovery with error handling"""
        scheduler_service.discovery.discover_devices.side_effect = Exception("Network error")
...
class TestVulnerabilityScanning:
    ...
    def test_run_vulnerability_scan_success(self, scheduler_service, sample_scan, sample_device):
        ...
        scheduler_service.vuln_scanner.scan_device_vulnerabilities.return_value = vulnerabilities
        ...
        with patch('src.scheduler.tasks.Scan') as mock_scan_class:
            ...
            scheduler_service.vuln_scanner.scan_device_vulnerabilities.assert_called_once_with(sample_device.id)
    ...
    def test_run_vulnerability_scan_with_critical_alert(self, scheduler_service, sample_scan, sample_device):
        ...
        with patch('src.scheduler.tasks.Scan') as mock_scan_class:
            ...
            call_args = scheduler_service.alert_manager.send_critical_vulnerability_alert.call_args
    ...
    def test_run_vulnerability_scan_error(self, scheduler_service, sample_scan):
        ...
        scheduler_service.db.query().filter_by().all.side_effect = Exception("Database error")
...
class TestHelperMethods:
    ...
    def test_should_deep_scan_recently_discovered(self, scheduler_service, sample_device):
    ...
    def test_check_new_devices_new_device(self, scheduler_service):
        ...
        scheduler_service.alert_manager.send_new_device_alert.assert_called_once_with(device_info)
...
class TestErrorRecovery:
    ...
    def test_discovery_partial_failure_recovery(self, scheduler_service, sample_scan, sample_device):
        ...
        scheduler_service.discovery.deep_scan_device.side_effect = Exception("Deep scan failed")
    ...
    def test_vulnerability_scan_device_failure_stops_scan(self, scheduler_service, sample_scan):
        ...
        scheduler_service.vuln_scanner.scan_device_vulnerabilities.side_effect = Exception("Scan failed")
        ...
        with patch('src.scheduler.tasks.Scan') as mock_scan_class:
            ...
            assert scheduler_service.vuln_scanner.scan_device_vulnerabilities.call_count == 1
...
class TestIntegrationScenarios:
    ...
    def test_full_scan_cycle(self, scheduler_service, sample_device):
        ...
        with patch('src.scheduler.tasks.Scan') as mock_scan_class, \
            ...
            assert scheduler_service.db.commit.call_count >= 3  # Discovery, vuln, cleanup