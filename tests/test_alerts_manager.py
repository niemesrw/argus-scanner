...
def mock_settings():
    ...
    settings.alert_slack_webhook = "https://hooks.slack.com/services/T00000000/B00000000/XXXXXXXXXXXXXXXXXXXXXXXX"
...
class TestCriticalVulnerabilityAlerts:
    ...
    def test_send_critical_vulnerability_alert(self, alert_manager, sample_device, sample_vulnerabilities):
        """Test sending critical vulnerability alert"""
        with patch('src.alerts.manager.Alert') as mock_alert_class, \
             patch.object(alert_manager, '_send_notifications') as mock_send_notifications:
            
            mock_alert = Mock()
            mock_alert_class.return_value = mock_alert
            
            alert_manager.send_critical_vulnerability_alert(sample_device, sample_vulnerabilities)
    ...
    def test_critical_vulnerability_alert_message_format(self, alert_manager, sample_device, sample_vulnerabilities):
        """Test critical vulnerability alert message formatting"""
        with patch('src.alerts.manager.Alert') as mock_alert_class, \
             patch.object(alert_manager, '_send_notifications'):
    ...
    def test_critical_vulnerability_alert_no_hostname(self, alert_manager, sample_device, sample_vulnerabilities):
...
class TestNotificationSystem:
    ...
    def test_send_notifications_info_alert_development(self, alert_manager, sample_alert):
    ...
    def test_send_notifications_info_alert_production(self, alert_manager, sample_alert):
...
class TestEmailNotifications:
    ...
    def test_send_email_notification_incomplete_config(self, alert_manager, sample_alert):
...
class TestSlackNotifications:
    ...
    def test_send_slack_notification_success(self, mock_post, alert_manager, sample_alert):
    ...
    @patch('src.alerts.manager.requests.post')
    def test_send_slack_notification_colors(self, mock_post, alert_manager, sample_alert):
    ...
    @patch('src.alerts.manager.requests.post')
    def test_send_slack_notification_critical_actions(self, mock_post, alert_manager, sample_alert):
    ...
    @patch('src.alerts.manager.requests.post')
    def test_send_slack_notification_non_critical_no_actions(self, mock_post, alert_manager, sample_alert):
    ...
    @patch('src.alerts.manager.requests.post')
    def test_send_slack_notification_api_error(self, mock_post, alert_manager, sample_alert):
...
class TestIntegrationScenarios:
    ...
    def test_full_critical_vulnerability_workflow(self, alert_manager, sample_device, sample_vulnerabilities):
        """Test complete critical vulnerability alert workflow"""
        with patch('src.alerts.manager.Alert') as mock_alert_class, \
             patch.object(alert_manager, '_send_email_notification') as mock_email, \
             patch.object(alert_manager, '_send_slack_notification') as mock_slack:
    ...
    def test_notification_failure_resilience(self, alert_manager, sample_device, sample_vulnerabilities):
        ...
        with patch('src.alerts.manager.Alert') as mock_alert_class:
            ...
            mock_alert.severity = Severity.CRITICAL  # Ensure it's critical so notifications are sent
            mock_alert_class.return_value = mock_alert
    ...
    def test_multiple_alert_types_workflow(self, alert_manager, sample_device):
        ...
        with patch('src.alerts.manager.Alert') as mock_alert_class, \
            ...
            alert_manager.send_exploit_success_alert(sample_device, {'vulnerability_name': 'Test'})
