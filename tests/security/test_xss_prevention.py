...
class TestXSSPrevention:
    ...
    def test_device_list_xss_prevention(self, security_client, security_db_session, malicious_payloads):
        """Test XSS prevention in device list page"""
        
        # Create devices with XSS payloads in various fields
        for i, payload in enumerate(malicious_payloads['xss'][:3]):  # Test first 3 payloads
            device = Device(
    ...
    def test_device_detail_xss_prevention(self, security_client, security_db_session, malicious_payloads):
        ...
        for char in dangerous_chars:
            if char in xss_payload:
                # Should be encoded
                assert response_text.count(char) == 0 or '&lt;' in response_text or '&gt;' in response_text
    
    def test_vulnerability_list_xss_prevention(self, security_client, security_db_session, malicious_payloads):
    ...
    def test_alert_list_xss_prevention(self, security_client, security_db_session, malicious_payloads):
    ...
    def test_api_response_xss_prevention(self, security_client, security_db_session, malicious_payloads):
    ...
    def test_search_results_xss_prevention(self, security_client, security_db_session, malicious_payloads):
    ...
    def test_content_security_policy_headers(self, security_client):
        ...
        if not has_security_header:
            print("Warning: No security headers found. Consider implementing CSP headers.")
    
    def test_script_tag_injection_prevention(self, security_client, security_db_session):
    ...
    def test_event_handler_injection_prevention(self, security_client, security_db_session):
    ...
    def test_json_xss_prevention(self, security_client, security_db_session, malicious_payloads):
