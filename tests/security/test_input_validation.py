...
class TestInputValidation:
    ...
    def test_api_device_creation_input_validation(self, security_client, malicious_payloads, invalid_inputs):
        ...
        for payload in malicious_payloads['sql_injection']:
            ...
            response = security_client.post('/api/devices', 
                                          json=device_data,
                                          content_type='application/json')
            
            # Should reject malicious input
            assert response.status_code in [400, 422], f"Should reject SQL injection payload: {payload}"
    ...
    def test_api_search_input_validation(self, security_client, malicious_payloads):
        ...
        for payload in malicious_payloads['xss']:
            ...
            assert response.status_code in [200, 400], f"Should handle XSS payload: {payload}"
    ...
    def test_api_data_type_validation(self, security_client, invalid_inputs):
        ...
        test_cases = [
            {'mac_address': 123, 'ip_address': '192.168.1.1', 'hostname': 'test'},  # number instead of string
            {'mac_address': '00:11:22:33:44:55', 'ip_address': [], 'hostname': 'test'},  # array instead of string
            {'mac_address': '00:11:22:33:44:55', 'ip_address': '192.168.1.1', 'hostname': {}},  # object instead of string
        ]
        ...
        for test_case in test_cases:
            ...
            assert response.status_code in [400, 422], f"Should reject invalid data types: {test_case}"
    ...
    def test_api_required_fields_validation(self, security_client):
        ...
        for incomplete_data in incomplete_data_cases:
            ...
            assert response.status_code in [400, 422], f"Should reject incomplete data: {incomplete_data}"
    ...
    def test_api_ip_address_format_validation(self, security_client):
        ...
        for invalid_ip in invalid_ips:
            ...
            assert response.status_code in [400, 422], f"Should reject invalid IP: {invalid_ip}"
    ...
    def test_api_mac_address_format_validation(self, security_client):
        ...
        for invalid_mac in invalid_macs:
            ...
            assert response.status_code in [400, 422], f"Should reject invalid MAC: {invalid_mac}"
    ...
    def test_http_method_validation(self, security_client):
        ...
        for endpoint in endpoints_to_test:
            ...
            for method in unsupported_methods:
                ...
                assert response.status_code in [405], f"Method {method} should not be allowed on {endpoint}"