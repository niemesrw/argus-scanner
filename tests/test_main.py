...
class TestMainFunction:
    ...
    def test_main_function_complete_flow(
        ...
        with patch("logging.getLogger") as mock_get_logger:
            ...
            mock_logger.info.assert_any_call(
                "Starting Argus Scanner in development mode"
            )
    ...
    @patch("src.main.SchedulerService")
    @patch("src.main.create_app")
    def test_main_function_production_mode(
        self,
        mock_create_app,
        mock_scheduler_service,
        mock_init_db,
        ...
        with patch("logging.getLogger") as mock_get_logger:
            ...
            mock_logger.info.assert_any_call(
                "Starting Argus Scanner in production mode"
            )
            ...
            mock_app.run.assert_called_once_with(host="0.0.0.0", port=80, debug=False)
    ...
    @patch("src.main.SchedulerService")
    @patch("src.main.create_app")
    def test_main_function_custom_port(
        self,
        mock_create_app,
        mock_scheduler_service,
        mock_init_db,
...
class TestApplicationStartup:
    ...
    @patch("src.main.SchedulerService")
    @patch("src.main.create_app")
    def test_startup_with_database_error(
        self,
        mock_create_app,
        mock_scheduler_service,
        mock_init_db,
    ...
    @patch("src.main.SchedulerService")
    @patch("src.main.create_app")
    def test_startup_with_scheduler_error(
        self,
        mock_create_app,
        mock_scheduler_service,
        mock_init_db,
    ...
    @patch("src.main.SchedulerService")
    @patch("src.main.create_app")
    def test_startup_with_web_app_creation_error(
        self,
        mock_create_app,
        mock_scheduler_service,
        mock_init_db,
    ...
    @patch("src.main.Settings")
    @patch("src.main.setup_logging")
    def test_startup_with_logging_setup_error(
        self, mock_setup_logging, mock_settings_class
    ):
...
class TestErrorLogging:
    ...
    @patch("src.main.SchedulerService")
    @patch("src.main.create_app")
    def test_startup_success_logging(
        self,
        mock_create_app,
        mock_scheduler_service,
        mock_init_db,
...
class TestEnvironmentSpecificBehavior:
    ...
    @patch("src.main.SchedulerService")
    @patch("src.main.create_app")
    def test_development_environment_behavior(
        self,
        mock_create_app,
        mock_scheduler_service,
        mock_init_db,
    ...
    @patch("src.main.SchedulerService")
    @patch("src.main.create_app")
    def test_staging_environment_behavior(
        self,
        mock_create_app,
        mock_scheduler_service,
        mock_init_db,
        ...
        with patch("logging.getLogger") as mock_get_logger:
            ...
            mock_app.run.assert_called_once_with(
                host="0.0.0.0", port=8080, debug=False  # Debug mode disabled in staging
            )
